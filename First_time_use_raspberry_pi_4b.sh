#!/bin/bash
# This scripts sets up wifi on a Raspberry Pi 4B (RPI) and then setus up SSH over tor and helps 
# you copy the onion address at which you can ssh into this RPI to your host device/pc. 
# It also updates Ubuntu.
